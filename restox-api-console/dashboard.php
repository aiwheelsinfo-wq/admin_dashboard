...
if (!$p) {
    // If partner not found, log them out
    session_destroy();
    header("Location: login.php");
    exit();
}
    ...
    <main class="dashboard-container">
        ...
        <?php if ($p['status'] === 'pending'): ?>
            <div class="status-banner status-banner-pending">
                ...
                <div>
                    ...
                    <p class="status-desc">Your registration request is currently being verified by the administrator. Once approved, your API keys and endpoints reference will automatically activate here.</p>
                </div>
            </div>
        <?php elseif ($p['status'] === 'blocked'): ?>
            <div class="status-banner status-banner-blocked">
                ...
                <div>
                    <h3 class="status-title">Access Terminated / Blocked</h3>
                    <p class="status-desc">Access credentials for this account have been suspended. Please get in touch with our partner operations manager to resolve this.</p>
                </div>
            </div>
        <?php else: ?>
            ...
            <section class="panel-card">
                ...
                <div class="info-list">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?= htmlspecialchars($p['company_owner_name'] ?? 'N/A') ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">GST Number</span>
                        <span class="info-value" style="font-family: monospace; color:#818cf8;"><?= htmlspecialchars($p['gst_number'] ?? 'N/A') ?></span>
                    </div>
                    <div class="info-item">
